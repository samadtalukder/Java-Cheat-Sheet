...
- [Example 1](https://github.com/samadtalukder/Java-Programming-Example/tree/master/src/com/string)
...
#### Enum Example 2
```
package com.java.beginners.concept.examples.enums;
...
```
package com.classmodifiers.defaultaccess.a;
...
```
package com.classmodifiers.defaultaccess.b;
...
```
package com.membermodifiers.access;
...
Look at the code below to understand what can be accessed and what cannot be.
```
package com.membermodifiers.access.different;

import com.membermodifiers.access.ExampleClass;
...
com.exceptionhandling.ExceptionHandlingExample1.main(ExceptionHandlingExample1.java:6)
```
...
com.exceptionhandling.ExceptionHandlingExample1.method2(ExceptionHandlingExample1.java:15)
at com.exceptionhandling.ExceptionHandlingExample1.method1(ExceptionHandlingExample1.java:10)
at com.exceptionhandling.ExceptionHandlingExample1.main(ExceptionHandlingExample1.java:6)
```
...
at com.exceptionhandling.ExceptionHandlingExample1.method2(ExceptionHandlingExample1.java:18)
at com.exceptionhandling.ExceptionHandlingExample1.method1(ExceptionHandlingExample1.java:12)
at com.exceptionhandling.ExceptionHandlingExample1.main(ExceptionHandlingExample1.java:7)
```
...
Connection Opened
Connection Closed
Exception in thread "main" java.lang.NullPointerException at com.exceptionhandling.ExceptionHandlingExample1.method2(ExceptionHandlingExample1.java:33) at com.exceptionhandling.ExceptionHandlingExample1.method1(ExceptionHandlingExample1.java:22) at com.exceptionhandling.ExceptionHandlingExample1.main(ExceptionHandlingExample1.java:17)
```
...
at com.exceptionhandling.AmountAdder.addAmounts(ExceptionHandlingExample2.java:17)
at com.exceptionhandling.ExceptionHandlingExample2.main(ExceptionHandlingExample2.java:28)
```
...
Output:
```
Exception in thread "main" com.in28minutes.exceptionhandling.CurrenciesDoNotMatchException at com.exceptionhandling.AmountAdder.addAmounts(ExceptionHandlingExample2.java:21)
at com.exceptionhandling.ExceptionHandlingExample2.main(ExceptionHandlingExample2.java:30)
```
...
try {
	...
	//Output : Exception in thread "main" java.lang.NullPointerException at com.exceptionhandling.ExceptionHandlingExample2.main(ExceptionHandlingExample2.java:34)
```
...
//Output:
//Exception in thread "main" java.io.NotSerializableException: com.serialization.Wall
